const PowerSource = ({ powerSource }: { powerSource: number | undefined }) => {

    if (powerSource === 1) { // Wired
        return (<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-plug-fill" viewBox="0 0 16 16">
    ...
    } else if (powerSource === 2) { // Battery
        return (<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-battery-full" viewBox="0 0 16 16">
            <path d="M2 6h10v4H2z" />
